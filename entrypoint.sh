...
UUID=${UUID:-'ca706cd4-28d2-47db-92d7-7ee2f88dbac0'}
VMESS_WSPATH=${VMESS_WSPATH:-'/ca706cd4-28d2-47db-92d7-7ee2f88dbac0-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/ca706cd4-28d2-47db-92d7-7ee2f88dbac0-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/ca706cd4-28d2-47db-92d7-7ee2f88dbac0-trojan'}
SS_WSPATH=${SS_WSPATH:-'/ca706cd4-28d2-47db-92d7-7ee2f88dbac0-shadowsocks'}
